# Custom Scheduler
Планировщик задач на Node.js. Поддерживает различные уровни логирования: `trace`, `debug`, `info`, `warn`, `error`.
...
# Запуск с просмотром информации о покрытии кода тестами
